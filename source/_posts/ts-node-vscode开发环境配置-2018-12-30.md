---
title: ts+node+vscode开发环境配置
date: 2018-12-30 16:18:06
tags: [vscode,ts,node]
---
  ...
  "configurations": [
    {
      ...
      "request": "launch",
      "name": "ts-node",
      "program": "${workspaceFolder}/examples/ts-demo/index.js",
      "outFiles": ["${workspaceFolder}/examples/ts-demo/*.js"]
    }
  ]
}
```

## 配置ts sourcemap 可以用来调试
```json
{
  "compilerOptions": {
    /* Basic Options */
